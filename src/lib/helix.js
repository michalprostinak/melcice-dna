...
export const VIEWS_DESKTOP = [
  ...
  v({ x: 0.6, dist: 7, phi: 0.15, dim: 0.95 }), // 01 code (text left)
  v({ x: -0.6, dist: 7, phi: P - 0.15, dim: 0.95 }), // 02 create (text right)
  v({ x: 0.6, dist: 7, phi: 0.15, dim: 0.95 }), // 03 learn (text left)
  v({ x: -0.6, dist: 7, phi: P - 0.15, dim: 0.95 }), // 04 share (text right)
  v({ x: 0.6, dist: 7, phi: 0.15, dim: 0.95 }), // 05 ship (text left)
  v({ dist: 9, phi: P / 2, dim: 0.3 }), // 06 people
  v({ dist: 10, phi: -P / 2, dim: 0.32 }), // 07 melčice
  v({ dist: 9, phi: P - 0.15, dim: 0.36 }), // 08 events
  v({ dist: 8.5, phi: 0.15, dim: 0.45 }), // 09 hack club
];
